package com.think.framework.manager.factory;

import com.think.common.constant.Constants;
import com.think.common.utils.LogUtils;
import com.think.common.utils.ServletUtils;
import com.think.common.utils.ip.AddressUtils;
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message,
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                logininfor.setOs(os);
                logininfor.setUserAgent(userAgent.toString());
